...
const
  targetOS* =
    when defined(windows):
      ...
      OsPlatform.standalone
    elif defined(nintendoswitch):
      OsPlatform.nintendoswitch
    else:
      OsPlatform.none ## the OS this program will run on.
  ...
  targetCPU* =
    when defined(i386):
      ...
      CpuPlatform.powerpc64
    elif defined(powerpc64el):
      CpuPlatform.powerpc64el
    elif defined(sparc):
      CpuPlatform.sparc
      ...
      CpuPlatform.mips64
    elif defined(mips64el):
      CpuPlatform.mips64el
    elif defined(arm):
      CpuPlatform.arm
    elif defined(arm64):
      CpuPlatform.arm64
      ...
      CpuPlatform.loongarch64
    elif defined(s390x):
      CpuPlatform.s390x
    else:
      CpuPlatform.none ## the CPU this program will run on.
