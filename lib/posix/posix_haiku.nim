...
type
  Time* {.importc: "time_t", header: "<time.h>".} =
    distinct (when defined(i386): int32 else: int64)
  ...
  Pthread_barrier* {.importc: "pthread_barrier_t", header: "<sys/types.h>".} = object

  Pthread_barrierattr* {.importc: "pthread_barrierattr_t", header: "<sys/types.h>".} = object
  Pthread_cond* {.importc: "pthread_cond_t", header: "<sys/types.h>".} = object

  Pthread_condattr* {.importc: "pthread_condattr_t", header: "<sys/types.h>".} = object
  ...
  Pthread_mutexattr* {.importc: "pthread_mutexattr_t", header: "<sys/types.h>".} = object
  Pthread_once* {.importc: "pthread_once_t", header: "<sys/types.h>".} = object

  Pthread_rwlock* {.importc: "pthread_rwlock_t", header: "<sys/types.h>".} = object

  Pthread_rwlockattr* {.importc: "pthread_rwlockattr_t", header: "<sys/types.h>".} = object

  Pthread_spinlock* {.importc: "pthread_spinlock_t", header: "<sys/types.h>".} = object
