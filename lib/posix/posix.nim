...
const StatHasNanoseconds* =
  defined(linux) or defined(freebsd) or defined(osx) or defined(openbsd) or
...
when hasAioH:
  ...
  proc aio_suspend*(
    a1: ptr ptr Taiocb, a2: cint, a3: ptr Timespec
  ): cint {.importc, header: "<aio.h>".}

  proc aio_write*(a1: ptr Taiocb): cint {.importc, header: "<aio.h>".}
  proc lio_listio*(
    a1: cint, a2: ptr ptr Taiocb, a3: cint, a4: ptr SigEvent
  ): cint {.importc, header: "<aio.h>".}
...
proc inet_ntop*(
  a1: cint, a2: pointer | ptr InAddr | ptr In6Addr, a3: cstring, a4: int32
): cstring {.importc: "(char *)$1", header: "<arpa/inet.h>".}

proc inet_pton*(
  a1: cint, a2: cstring, a3: pointer | ptr InAddr | ptr In6Addr
): cint {.importc, header: "<arpa/inet.h>".}
...
proc readdir_r*(
  a1: ptr DIR, a2: ptr Dirent, a3: ptr ptr Dirent
): cint {.importc, header: "<dirent.h>", sideEffect.}
...
proc dlopen*(
  a1: cstring, a2: cint
): pointer {.importc, header: "<dlfcn.h>", sideEffect.}

proc dlsym*(
  a1: pointer, a2: cstring
): pointer {.importc, header: "<dlfcn.h>", sideEffect.}

proc creat*(a1: cstring, a2: Mode): cint {.importc, header: "<fcntl.h>", sideEffect.}
proc fcntl*(
  a1: cint | SocketHandle, a2: cint
): cint {.varargs, importc, header: "<fcntl.h>", sideEffect.}

proc openImpl(
  a1: cstring, a2: cint
): cint {.varargs, importc: "open", header: "<fcntl.h>", sideEffect.}
...
proc posix_fadvise*(
  a1: cint, a2, a3: Off, a4: cint
): cint {.importc, header: "<fcntl.h>".}
...
when defined(osx): # 2001 POSIX evidently does not concern Apple
  ...
  proc posix_fallocate*(a1: cint, a2, a3: Off): cint =
    ...
    if fcntl(a1, F_PREALLOCATE, fst.addr) != cint(-1):
      ftruncate(a1, a2 + a3)
    else:
      cint(-1)
...
when not defined(haiku) and not defined(openbsd):
  proc fmtmsg*(
    a1: int, a2: cstring, a3: cint, a4, a5, a6: cstring
  ): cint {.importc, header: "<fmtmsg.h>".}

proc fnmatch*(a1, a2: cstring, a3: cint): cint {.importc, header: "<fnmatch.h>".}
proc ftw*(
  a1: cstring, a2: proc(x1: cstring, x2: ptr Stat, x3: cint): cint {.noconv.}, a3: cint
): cint {.importc, header: "<ftw.h>".}
...
proc glob*(
  a1: cstring, a2: cint, a3: proc(x1: cstring, x2: cint): cint {.noconv.}, a4: ptr Glob
): cint {.importc, header: "<glob.h>", sideEffect.}
...
proc getgrgid_r*(
  a1: Gid, a2: ptr Group, a3: cstring, a4: int, a5: ptr ptr Group
): cint {.importc, header: "<grp.h>".}

proc getgrnam_r*(
  a1: cstring, a2: ptr Group, a3: cstring, a4: int, a5: ptr ptr Group
): cint {.importc, header: "<grp.h>".}
...
proc iconv*(
  a1: Iconv, a2: var cstring, a3: var int, a4: var cstring, a5: var int
): int {.importc, header: "<iconv.h>".}
...
proc setlocale*(
  a1: cint, a2: cstring
): cstring {.importc, header: "<locale.h>", sideEffect.}

proc strfmon*(
  a1: cstring, a2: int, a3: cstring
): int {.varargs, importc, header: "<monetary.h>".}

when not (defined(nintendoswitch) or defined(macos) or defined(macosx)):
  proc mq_notify*(
    mqdes: Mqd, event: ptr SigEvent
  ): cint {.importc, header: "<mqueue.h>".}

  proc mq_open*(
    name: cstring, flags: cint
  ): Mqd {.varargs, importc, header: "<mqueue.h>".}

  proc mq_close*(mqdes: Mqd): cint {.importc, header: "<mqueue.h>".}

  proc mq_receive*(
    mqdes: Mqd, buffer: cstring, length: csize_t, priority: var cuint
  ): int {.importc, header: "<mqueue.h>".}

  proc mq_timedreceive*(
    mqdes: Mqd, buffer: cstring, length: csize_t, priority: cuint, timeout: ptr Timespec
  ): int {.importc, header: "<mqueue.h>".}

  proc mq_send*(
    mqdes: Mqd, buffer: cstring, length: csize_t, priority: cuint
  ): cint {.importc, header: "<mqueue.h>".}
  ...
  proc mq_getattr*(
    mqdes: Mqd, attribute: ptr MqAttr
  ): cint {.importc, header: "<mqueue.h>".}

  proc mq_setattr*(
    mqdes: Mqd, newAttribute, oldAttribute: ptr MqAttr
  ): cint {.importc, header: "<mqueue.h>".}
...
proc getpwnam_r*(
  a1: cstring, a2: ptr Passwd, a3: cstring, a4: int, a5: ptr ptr Passwd
): cint {.importc, header: "<pwd.h>".}

proc getpwuid_r*(
  a1: Uid, a2: ptr Passwd, a3: cstring, a4: int, a5: ptr ptr Passwd
): cint {.importc, header: "<pwd.h>".}
...
proc pthread_atfork*(
  a1, a2, a3: proc() {.noconv.}
): cint {.importc, header: "<pthread.h>".}

proc pthread_attr_destroy*(
  a1: ptr Pthread_attr
): cint {.importc, header: "<pthread.h>".}

proc pthread_attr_getdetachstate*(
  a1: ptr Pthread_attr, a2: cint
): cint {.importc, header: "<pthread.h>".}

proc pthread_attr_getguardsize*(
  a1: ptr Pthread_attr, a2: var cint
): cint {.importc, header: "<pthread.h>".}

proc pthread_attr_getinheritsched*(
  a1: ptr Pthread_attr, a2: var cint
): cint {.importc, header: "<pthread.h>".}

proc pthread_attr_getschedparam*(
  a1: ptr Pthread_attr, a2: ptr Sched_param
): cint {.importc, header: "<pthread.h>".}

proc pthread_attr_getschedpolicy*(
  a1: ptr Pthread_attr, a2: var cint
): cint {.importc, header: "<pthread.h>".}

proc pthread_attr_getscope*(
  a1: ptr Pthread_attr, a2: var cint
): cint {.importc, header: "<pthread.h>".}

proc pthread_attr_getstack*(
  a1: ptr Pthread_attr, a2: var pointer, a3: var int
): cint {.importc, header: "<pthread.h>".}

proc pthread_attr_getstackaddr*(
  a1: ptr Pthread_attr, a2: var pointer
): cint {.importc, header: "<pthread.h>".}

proc pthread_attr_getstacksize*(
  a1: ptr Pthread_attr, a2: var int
): cint {.importc, header: "<pthread.h>".}

proc pthread_attr_init*(a1: ptr Pthread_attr): cint {.importc, header: "<pthread.h>".}
proc pthread_attr_setdetachstate*(
  a1: ptr Pthread_attr, a2: cint
): cint {.importc, header: "<pthread.h>".}

proc pthread_attr_setguardsize*(
  a1: ptr Pthread_attr, a2: int
): cint {.importc, header: "<pthread.h>".}

proc pthread_attr_setinheritsched*(
  a1: ptr Pthread_attr, a2: cint
): cint {.importc, header: "<pthread.h>".}

proc pthread_attr_setschedparam*(
  a1: ptr Pthread_attr, a2: ptr Sched_param
): cint {.importc, header: "<pthread.h>".}

proc pthread_attr_setschedpolicy*(
  a1: ptr Pthread_attr, a2: cint
): cint {.importc, header: "<pthread.h>".}

proc pthread_attr_setscope*(
  a1: ptr Pthread_attr, a2: cint
): cint {.importc, header: "<pthread.h>".}

proc pthread_attr_setstack*(
  a1: ptr Pthread_attr, a2: pointer, a3: int
): cint {.importc, header: "<pthread.h>".}

proc pthread_attr_setstackaddr*(
  a1: ptr Pthread_attr, a2: pointer
): cint {.importc, header: "<pthread.h>".}

proc pthread_attr_setstacksize*(
  a1: ptr Pthread_attr, a2: int
): cint {.importc, header: "<pthread.h>".}
...
proc pthread_barrier_init*(
  a1: ptr Pthread_barrier, a2: ptr Pthread_barrierattr, a3: cint
): cint {.importc, header: "<pthread.h>".}
...
proc pthread_barrierattr_destroy*(
  a1: ptr Pthread_barrierattr
): cint {.importc, header: "<pthread.h>".}

proc pthread_barrierattr_getpshared*(
  a1: ptr Pthread_barrierattr, a2: var cint
): cint {.importc, header: "<pthread.h>".}

proc pthread_barrierattr_init*(
  a1: ptr Pthread_barrierattr
): cint {.importc, header: "<pthread.h>".}

proc pthread_barrierattr_setpshared*(
  a1: ptr Pthread_barrierattr, a2: cint
): cint {.importc, header: "<pthread.h>".}

proc pthread_cancel*(a1: Pthread): cint {.importc, header: "<pthread.h>".}
proc pthread_cleanup_push*(
  a1: proc(x: pointer) {.noconv.}, a2: pointer
...
proc pthread_cond_init*(
  a1: ptr Pthread_cond, a2: ptr Pthread_condattr
): cint {.importc, header: "<pthread.h>".}

proc pthread_cond_signal*(a1: ptr Pthread_cond): cint {.importc, header: "<pthread.h>".}
proc pthread_cond_timedwait*(
  a1: ptr Pthread_cond, a2: ptr Pthread_mutex, a3: ptr Timespec
): cint {.importc, header: "<pthread.h>".}

proc pthread_cond_wait*(
  a1: ptr Pthread_cond, a2: ptr Pthread_mutex
): cint {.importc, header: "<pthread.h>".}

proc pthread_condattr_destroy*(
  a1: ptr Pthread_condattr
): cint {.importc, header: "<pthread.h>".}

proc pthread_condattr_getclock*(
  a1: ptr Pthread_condattr, a2: var ClockId
): cint {.importc, header: "<pthread.h>".}

proc pthread_condattr_getpshared*(
  a1: ptr Pthread_condattr, a2: var cint
): cint {.importc, header: "<pthread.h>".}

proc pthread_condattr_init*(
  a1: ptr Pthread_condattr
): cint {.importc, header: "<pthread.h>".}

proc pthread_condattr_setclock*(
  a1: ptr Pthread_condattr, a2: ClockId
): cint {.importc, header: "<pthread.h>".}

proc pthread_condattr_setpshared*(
  a1: ptr Pthread_condattr, a2: cint
): cint {.importc, header: "<pthread.h>".}
...
proc pthread_getcpuclockid*(
  a1: Pthread, a2: var ClockId
): cint {.importc, header: "<pthread.h>".}

proc pthread_getschedparam*(
  a1: Pthread, a2: var cint, a3: ptr Sched_param
): cint {.importc, header: "<pthread.h>".}

proc pthread_getspecific*(a1: Pthread_key): pointer {.importc, header: "<pthread.h>".}
proc pthread_join*(
  a1: Pthread, a2: ptr pointer
): cint {.importc, header: "<pthread.h>".}

proc pthread_key_create*(
  a1: ptr Pthread_key, a2: proc(x: pointer) {.noconv.}
): cint {.importc, header: "<pthread.h>".}
...
proc pthread_mutex_getprioceiling*(
  a1: ptr Pthread_mutex, a2: var cint
): cint {.importc, header: "<pthread.h>".}

proc pthread_mutex_init*(
  a1: ptr Pthread_mutex, a2: ptr Pthread_mutexattr
): cint {.importc, header: "<pthread.h>".}

proc pthread_mutex_lock*(a1: ptr Pthread_mutex): cint {.importc, header: "<pthread.h>".}
proc pthread_mutex_setprioceiling*(
  a1: ptr Pthread_mutex, a2: cint, a3: var cint
): cint {.importc, header: "<pthread.h>".}

proc pthread_mutex_timedlock*(
  a1: ptr Pthread_mutex, a2: ptr Timespec
): cint {.importc, header: "<pthread.h>".}
...
proc pthread_mutexattr_destroy*(
  a1: ptr Pthread_mutexattr
): cint {.importc, header: "<pthread.h>".}

proc pthread_mutexattr_getprioceiling*(
  a1: ptr Pthread_mutexattr, a2: var cint
): cint {.importc, header: "<pthread.h>".}

proc pthread_mutexattr_getprotocol*(
  a1: ptr Pthread_mutexattr, a2: var cint
): cint {.importc, header: "<pthread.h>".}

proc pthread_mutexattr_getpshared*(
  a1: ptr Pthread_mutexattr, a2: var cint
): cint {.importc, header: "<pthread.h>".}

proc pthread_mutexattr_gettype*(
  a1: ptr Pthread_mutexattr, a2: var cint
): cint {.importc, header: "<pthread.h>".}

proc pthread_mutexattr_init*(
  a1: ptr Pthread_mutexattr
): cint {.importc, header: "<pthread.h>".}

proc pthread_mutexattr_setprioceiling*(
  a1: ptr Pthread_mutexattr, a2: cint
): cint {.importc, header: "<pthread.h>".}

proc pthread_mutexattr_setprotocol*(
  a1: ptr Pthread_mutexattr, a2: cint
): cint {.importc, header: "<pthread.h>".}

proc pthread_mutexattr_setpshared*(
  a1: ptr Pthread_mutexattr, a2: cint
): cint {.importc, header: "<pthread.h>".}

proc pthread_mutexattr_settype*(
  a1: ptr Pthread_mutexattr, a2: cint
): cint {.importc, header: "<pthread.h>".}

proc pthread_once*(
  a1: ptr Pthread_once, a2: proc() {.noconv.}
): cint {.importc, header: "<pthread.h>".}
...
proc pthread_rwlock_init*(
  a1: ptr Pthread_rwlock, a2: ptr Pthread_rwlockattr
): cint {.importc, header: "<pthread.h>".}
...
proc pthread_rwlock_timedrdlock*(
  a1: ptr Pthread_rwlock, a2: ptr Timespec
): cint {.importc, header: "<pthread.h>".}

proc pthread_rwlock_timedwrlock*(
  a1: ptr Pthread_rwlock, a2: ptr Timespec
): cint {.importc, header: "<pthread.h>".}
...
proc pthread_rwlockattr_destroy*(
  a1: ptr Pthread_rwlockattr
): cint {.importc, header: "<pthread.h>".}

proc pthread_rwlockattr_getpshared*(
  a1: ptr Pthread_rwlockattr, a2: var cint
): cint {.importc, header: "<pthread.h>".}

proc pthread_rwlockattr_init*(
  a1: ptr Pthread_rwlockattr
): cint {.importc, header: "<pthread.h>".}

proc pthread_rwlockattr_setpshared*(
  a1: ptr Pthread_rwlockattr, a2: cint
): cint {.importc, header: "<pthread.h>".}

proc pthread_self*(): Pthread {.importc, header: "<pthread.h>".}
proc pthread_setcancelstate*(
  a1: cint, a2: var cint
): cint {.importc, header: "<pthread.h>".}

proc pthread_setcanceltype*(
  a1: cint, a2: var cint
): cint {.importc, header: "<pthread.h>".}

proc pthread_setconcurrency*(a1: cint): cint {.importc, header: "<pthread.h>".}
proc pthread_setschedparam*(
  a1: Pthread, a2: cint, a3: ptr Sched_param
): cint {.importc, header: "<pthread.h>".}

proc pthread_setschedprio*(
  a1: Pthread, a2: cint
): cint {.importc, header: "<pthread.h>".}

proc pthread_setspecific*(
  a1: Pthread_key, a2: pointer
): cint {.importc, header: "<pthread.h>".}
...
proc pthread_spin_init*(
  a1: ptr Pthread_spinlock, a2: cint
): cint {.importc, header: "<pthread.h>".}
...
proc execv*(
  a1: cstring, a2: cstringArray
): cint {.importc, header: "<unistd.h>", sideEffect.}

proc execve*(
  a1: cstring, a2, a3: cstringArray
): cint {.importc, header: "<unistd.h>", sideEffect.}
...
proc execvpe*(
  a1: cstring, a2: cstringArray, a3: cstringArray
): cint {.importc, header: "<unistd.h>", sideEffect.}

proc fchown*(
  a1: cint, a2: Uid, a3: Gid
): cint {.importc, header: "<unistd.h>", sideEffect.}
...
proc getcwd*(
  a1: cstring, a2: int
): cstring {.importc, header: "<unistd.h>", sideEffect.}
...
proc getgroups*(
  a1: cint, a2: ptr array[0 .. 255, Gid]
...
proc getopt*(
  a1: cint, a2: cstringArray, a3: cstring
): cint {.importc, header: "<unistd.h>".}
...
proc pread*(
  a1: cint, a2: pointer, a3: int, a4: Off
): int {.importc, header: "<unistd.h>".}
...
proc ioctl*(
  f: FileHandle, device: uint
): int {.importc: "ioctl", header: "<sys/ioctl.h>", varargs, tags: [WriteIOEffect].}
...
when not defined(nintendoswitch):
  ...
  proc symlink*(a1, a2: cstring): cint =
    -1
...
proc sem_init*(
  a1: ptr Sem, a2: cint, a3: cint
): cint {.importc, header: "<semaphore.h>".}

proc sem_open*(
  a1: cstring, a2: cint
): ptr Sem {.varargs, importc, header: "<semaphore.h>".}

proc sem_post*(a1: ptr Sem): cint {.importc, header: "<semaphore.h>".}
proc sem_timedwait*(
  a1: ptr Sem, a2: ptr Timespec
): cint {.importc, header: "<semaphore.h>".}
...
proc S_ISDIR*(m: Mode): bool {.importc, header: "<sys/stat.h>".} ## Test for a directory.
...
proc S_ISSOCK*(m: Mode): bool {.importc, header: "<sys/stat.h>".} ## Test for a socket.
...
proc mmap*(
  a1: pointer, a2: int, a3, a4, a5: cint, a6: Off
...
proc posix_madvise*(
  a1: pointer, a2: int, a3: cint
): cint {.importc, header: "<sys/mman.h>".}

proc posix_mem_offset*(
  a1: pointer, a2: int, a3: var Off, a4: var int, a5: var cint
): cint {.importc, header: "<sys/mman.h>".}

when not (defined(linux) and defined(amd64)) and not defined(nintendoswitch) and
    not defined(haiku):
  proc posix_typed_mem_get_info*(
    a1: cint, a2: var Posix_typed_mem_info
  ): cint {.importc, header: "<sys/mman.h>".}

proc posix_typed_mem_open*(
  a1: cstring, a2, a3: cint
): cint {.importc, header: "<sys/mman.h>".}

proc shm_open*(
  a1: cstring, a2: cint, a3: Mode
): cint {.importc, header: "<sys/mman.h>".}
...
proc clock_getcpuclockid*(
  a1: Pid, a2: var ClockId
): cint {.importc, header: "<time.h>", sideEffect.}

proc clock_getres*(
  a1: ClockId, a2: var Timespec
): cint {.importc, header: "<time.h>", sideEffect.}
...
proc clock_nanosleep*(
  a1: ClockId, a2: cint, a3: var Timespec, a4: var Timespec
): cint {.importc, header: "<time.h>", sideEffect.}
...
proc strftime*(
  a1: cstring, a2: int, a3: cstring, a4: var Tm
): int {.importc, header: "<time.h>".}
...
proc timer_create*(
  a1: ClockId, a2: var SigEvent, a3: var Timer
): cint {.importc, header: "<time.h>".}
...
proc timer_settime*(
  a1: Timer, a2: cint, a3: var Itimerspec, a4: var Itimerspec
): cint {.importc, header: "<time.h>".}
...
proc wait*(
  a1: ptr cint
): Pid {.importc, discardable, header: "<sys/wait.h>", sideEffect.}

proc waitid*(
  a1: cint, a2: Id, a3: var SigInfo, a4: cint
): cint {.importc, header: "<sys/wait.h>", sideEffect.}

proc waitpid*(
  a1: Pid, a2: var cint, a3: cint
): Pid {.importc, header: "<sys/wait.h>", sideEffect.}

type Rusage* {.importc: "struct rusage", header: "<sys/resource.h>", bycopy.} = object
  ru_utime*, ru_stime*: Timeval # User and system time
  ru_maxrss*,
    ru_ixrss*,
    ru_idrss*,
    ru_isrss*, # memory sizes
    ru_minflt*,
    ru_majflt*,
    ru_nswap*, # paging activity
    ru_inblock*,
    ru_oublock*,
    ru_msgsnd*,
    ru_msgrcv*, # IO activity
    ru_nsignals*,
    ru_nvcsw*,
    ru_nivcsw*: clong # switching activity

proc wait4*(
  pid: Pid, status: ptr cint, options: cint, rusage: ptr Rusage
): Pid {.importc, header: "<sys/wait.h>", sideEffect.}
...
proc getrusage*(
  who: cint, rusage: ptr Rusage
): cint {.importc, header: "<sys/resource.h>", discardable.}
...
proc signal*(
  a1: cint, a2: Sighandler
): Sighandler {.importc, discardable, header: "<signal.h>".}
...
when defined(android):
  ...
  var NR_rt_sigtimedwait {.importc: "__NR_rt_sigtimedwait", header: "<sys/syscall.h>".}:
    clong
  var NSIGMAX {.importc: "NSIG", header: "<signal.h>".}: clong

  proc sigtimedwait*(a1: var Sigset, a2: var SigInfo, a3: var Timespec): cint =
    result =
      cint(syscall(NR_rt_sigtimedwait, addr(a1), addr(a2), addr(a3), NSIGMAX div 8))

else:
  proc sigtimedwait*(
    a1: var Sigset, a2: var SigInfo, a3: var Timespec
  ): cint {.importc, header: "<signal.h>".}
...
proc sigwaitinfo*(
  a1: var Sigset, a2: var SigInfo
): cint {.importc, header: "<signal.h>".}

when not defined(nintendoswitch):
  proc catclose*(a1: Nl_catd): cint {.importc, header: "<nl_types.h>".}
  proc catgets*(
    a1: Nl_catd, a2, a3: cint, a4: cstring
  ): cstring {.importc, header: "<nl_types.h>".}
...
proc sched_setscheduler*(
  a1: Pid, a2: cint, a3: var Sched_param
): cint {.importc, header: "<sched.h>".}
...
proc FD_ISSET*(
  a1: cint | SocketHandle, a2: var TFdSet
): cint {.importc, header: "<sys/select.h>".}
...
proc pselect*(
  a1: cint, a2, a3, a4: ptr TFdSet, a5: ptr Timespec, a6: var Sigset
): cint {.importc, header: "<sys/select.h>".}

proc select*(
  a1: cint | SocketHandle, a2, a3, a4: ptr TFdSet, a5: ptr Timeval
): cint {.importc, header: "<sys/select.h>".}
...
when hasSpawnH:
  ...
  proc posix_spawn_file_actions_addclose*(
    a1: var Tposix_spawn_file_actions, a2: cint
  ): cint {.importc, header: "<spawn.h>".}

  proc posix_spawn_file_actions_adddup2*(
    a1: var Tposix_spawn_file_actions, a2, a3: cint
  ): cint {.importc, header: "<spawn.h>".}

  proc posix_spawn_file_actions_addopen*(
    a1: var Tposix_spawn_file_actions, a2: cint, a3: cstring, a4: cint, a5: Mode
  ): cint {.importc, header: "<spawn.h>".}
  ...
  proc posix_spawnattr_getsigdefault*(
    a1: var Tposix_spawnattr, a2: var Sigset
  ): cint {.importc, header: "<spawn.h>".}

  proc posix_spawnattr_getflags*(
    a1: var Tposix_spawnattr, a2: var cshort
  ): cint {.importc, header: "<spawn.h>".}

  proc posix_spawnattr_getpgroup*(
    a1: var Tposix_spawnattr, a2: var Pid
  ): cint {.importc, header: "<spawn.h>".}

  proc posix_spawnattr_getschedparam*(
    a1: var Tposix_spawnattr, a2: var Sched_param
  ): cint {.importc, header: "<spawn.h>".}

  proc posix_spawnattr_getschedpolicy*(
    a1: var Tposix_spawnattr, a2: var cint
  ): cint {.importc, header: "<spawn.h>".}

  proc posix_spawnattr_getsigmask*(
    a1: var Tposix_spawnattr, a2: var Sigset
  ): cint {.importc, header: "<spawn.h>".}
  ...
  proc posix_spawnattr_setsigdefault*(
    a1: var Tposix_spawnattr, a2: var Sigset
  ): cint {.importc, header: "<spawn.h>".}

  proc posix_spawnattr_setflags*(
    a1: var Tposix_spawnattr, a2: cint
  ): cint {.importc, header: "<spawn.h>".}

  proc posix_spawnattr_setpgroup*(
    a1: var Tposix_spawnattr, a2: Pid
  ): cint {.importc, header: "<spawn.h>".}

  proc posix_spawnattr_setschedparam*(
    a1: var Tposix_spawnattr, a2: var Sched_param
  ): cint {.importc, header: "<spawn.h>".}

  proc posix_spawnattr_setschedpolicy*(
    a1: var Tposix_spawnattr, a2: cint
  ): cint {.importc, header: "<spawn.h>".}

  proc posix_spawnattr_setsigmask*(
    a1: var Tposix_spawnattr, a2: var Sigset
  ): cint {.importc, header: "<spawn.h>".}
...
when not defined(nintendoswitch):
  ...
  proc makecontext*(
    a1: var Ucontext, a4: proc() {.noconv.}, a3: cint
...
proc CMSG_NXTHDR*(
  mhdr: ptr Tmsghdr, cmsg: ptr Tcmsghdr
): ptr Tcmsghdr {.importc, header: "<sys/socket.h>".}
...
proc accept*(
  a1: SocketHandle, a2: ptr SockAddr, a3: ptr SockLen
): SocketHandle {.importc, header: "<sys/socket.h>", sideEffect.}

when defined(linux) or defined(bsd) or defined(nuttx):
  proc accept4*(
    a1: SocketHandle, a2: ptr SockAddr, a3: ptr SockLen, flags: cint
  ): SocketHandle {.importc, header: "<sys/socket.h>".}

proc bindSocket*(
  a1: SocketHandle, a2: ptr SockAddr, a3: SockLen
): cint {.importc: "bind", header: "<sys/socket.h>".}
...
proc getsockopt*(
  a1: SocketHandle, a2, a3: cint, a4: pointer, a5: ptr SockLen
): cint {.importc, header: "<sys/socket.h>".}

proc listen*(
  a1: SocketHandle, a2: cint
): cint {.importc, header: "<sys/socket.h>", sideEffect.}

proc recv*(
  a1: SocketHandle, a2: pointer, a3: int, a4: cint
): int {.importc, header: "<sys/socket.h>", sideEffect.}

proc recvfrom*(
  a1: SocketHandle, a2: pointer, a3: int, a4: cint, a5: ptr SockAddr, a6: ptr SockLen
): int {.importc, header: "<sys/socket.h>", sideEffect.}

proc recvmsg*(
  a1: SocketHandle, a2: ptr Tmsghdr, a3: cint
): int {.importc, header: "<sys/socket.h>", sideEffect.}
...
proc sendto*(
  a1: SocketHandle, a2: pointer, a3: int, a4: cint, a5: ptr SockAddr, a6: SockLen
): int {.importc, header: "<sys/socket.h>", sideEffect.}

proc setsockopt*(
  a1: SocketHandle, a2, a3: cint, a4: pointer, a5: SockLen
): cint {.importc, header: "<sys/socket.h>".}
...
proc socketpair*(
  a1, a2, a3: cint, a4: var array[0 .. 1, cint]
): cint {.importc, header: "<sys/socket.h>".}
...
proc IN6_IS_ADDR_UNSPECIFIED*(
  a1: ptr In6Addr
): cint {.importc, header: "<netinet/in.h>".} ## Unspecified address.
...
when defined(lwip):
  ...
  proc IN6_IS_ADDR_V4MAPPED*(
    a1: ptr In6Addr
  ): cint {.importc, header: "<netinet/in.h>".} ## IPv4 mapped address.

proc IN6_IS_ADDR_V4COMPAT*(a1: ptr In6Addr): cint {.importc, header: "<netinet/in.h>".}
  ## IPv4-compatible address.

proc IN6_IS_ADDR_MC_NODELOCAL*(
  a1: ptr In6Addr
): cint {.importc, header: "<netinet/in.h>".} ## Multicast node-local address.

proc IN6_IS_ADDR_MC_LINKLOCAL*(
  a1: ptr In6Addr
): cint {.importc, header: "<netinet/in.h>".} ## Multicast link-local address.

proc IN6_IS_ADDR_MC_SITELOCAL*(
  a1: ptr In6Addr
): cint {.importc, header: "<netinet/in.h>".} ## Multicast site-local address.

proc IN6_IS_ADDR_MC_ORGLOCAL*(
  a1: ptr In6Addr
): cint {.importc, header: "<netinet/in.h>".} ## Multicast organization-local address.
...
proc getaddrinfo*(
  a1, a2: cstring, a3: ptr AddrInfo, a4: var ptr AddrInfo
): cint {.importc, header: "<netdb.h>".}

when not defined(android4):
  proc gethostbyaddr*(
    a1: pointer, a2: SockLen, a3: cint
  ): ptr Hostent {.importc, header: "<netdb.h>".}

else:
  proc gethostbyaddr*(
    a1: cstring, a2: cint, a3: cint
  ): ptr Hostent {.importc, header: "<netdb.h>".}
...
when not defined(lwip):
  ...
  when defined(linux) and not defined(android) or defined(haiku):
    type Tnfds* {.importc: "nfds_t", header: "<poll.h>".} = culong
  elif defined(zephyr):
    type Tnfds* = distinct cint
  else:
    type Tnfds* {.importc: "nfds_t", header: "<poll.h>".} = cuint
...
proc realpath*(
  name, resolved: cstring
): cstring {.importc: "realpath", header: "<stdlib.h>".}
...
proc mkstemps*(
  tmpl: cstring, suffixlen: int
): cint {.importc, header: "<stdlib.h>", sideEffect.}
  ## Creates a unique temporary file.
  ##
...
when defined(linux) or defined(bsd) or defined(osx):
  proc mkostemp*(
    tmpl: cstring, oflags: cint
  ): cint {.importc, header: "<stdlib.h>", sideEffect.}

  proc mkostemps*(
    tmpl: cstring, suffixlen: cint, oflags: cint
  ): cint {.importc, header: "<stdlib.h>", sideEffect.}

  proc posix_memalign*(
    memptr: pointer, alignment: csize_t, size: csize_t
  ): cint {.importc, header: "<stdlib.h>".}

proc utimes*(
  path: cstring, times: ptr array[2, Timeval]
): int {.importc: "utimes", header: "<sys/time.h>", sideEffect.}
...
proc handle_signal(
  sig: cint, handler: proc(a: cint) {.noconv.}
...
proc setrlimit*(
  resource: cint, rlp: var RLimit
): cint {.importc: "setrlimit", header: "<sys/resource.h>".}
  ## The setrlimit() system calls sets resource limits.

proc getrlimit*(
  resource: cint, rlp: var RLimit
): cint {.importc: "getrlimit", header: "<sys/resource.h>".}
