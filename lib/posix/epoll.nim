...
proc epoll_create*(
  size: cint
): cint {.importc: "epoll_create", header: "<sys/epoll.h>".}
...
proc epoll_create1*(
  flags: cint
): cint {.importc: "epoll_create1", header: "<sys/epoll.h>".}
  ## Same as epoll_create but with an FLAGS parameter.  The unused SIZE
  ## parameter has been dropped.

proc epoll_ctl*(
  epfd: cint, op: cint, fd: cint | SocketHandle, event: ptr EpollEvent
): cint {.importc: "epoll_ctl", header: "<sys/epoll.h>".}
...
): cint {.importc: "epoll_wait", header: "<sys/epoll.h>".}
