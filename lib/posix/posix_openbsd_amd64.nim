...
type
  ...
  Dev* {.importc: "dev_t", header: "<sys/types.h>".} =
    (when defined(freebsd): uint32 else: int32)
  ...
  Pthread_barrier* {.importc: "pthread_barrier_t", header: "<pthread.h>".} = int

  Pthread_barrierattr* {.importc: "pthread_barrierattr_t", header: "<pthread.h>".} = int
  Pthread_cond* {.importc: "pthread_cond_t", header: "<pthread.h>".} = int

  Pthread_condattr* {.importc: "pthread_condattr_t", header: "<pthread.h>".} = int
  Pthread_key* {.importc: "pthread_key_t", header: "<pthread.h>".} = int
  Pthread_mutex* {.importc: "pthread_mutex_t", header: "<pthread.h>".} = int

  Pthread_mutexattr* {.importc: "pthread_mutexattr_t", header: "<pthread.h>".} = int
  Pthread_once* {.importc: "pthread_once_t", header: "<pthread.h>".} = int

  Pthread_rwlock* {.importc: "pthread_rwlock_t", header: "<pthread.h>".} = int

  Pthread_rwlockattr* {.importc: "pthread_rwlockattr_t", header: "<pthread.h>".} = int

  Pthread_spinlock* {.importc: "pthread_spinlock_t", header: "<pthread.h>".} = int
