...
var LWIP_DNS_API_DECLARE_H_ERRNO* {.
  importc: "LWIP_DNS_API_DECLARE_H_ERRNO", header: "<netdb.h>"
.}: cint
var LWIP_DNS_API_DEFINE_ERRORS* {.
  importc: "LWIP_DNS_API_DEFINE_ERRORS", header: "<netdb.h>"
.}: cint
var LWIP_DNS_API_DEFINE_FLAGS* {.
  importc: "LWIP_DNS_API_DEFINE_FLAGS", header: "<netdb.h>"
.}: cint
var LWIP_DNS_API_DECLARE_STRUCTS* {.
  importc: "LWIP_DNS_API_DECLARE_STRUCTS", header: "<netdb.h>"
.}: cint
...
var NETIF_CHECKSUM_GEN_IP* {.importc: "NETIF_CHECKSUM_GEN_IP", header: "<netif.h>".}:
  cint
var NETIF_CHECKSUM_GEN_UDP* {.importc: "NETIF_CHECKSUM_GEN_UDP", header: "<netif.h>".}:
  cint
var NETIF_CHECKSUM_GEN_TCP* {.importc: "NETIF_CHECKSUM_GEN_TCP", header: "<netif.h>".}:
  cint
var NETIF_CHECKSUM_GEN_ICMP* {.importc: "NETIF_CHECKSUM_GEN_ICMP", header: "<netif.h>".}:
  cint
var NETIF_CHECKSUM_GEN_ICMP6* {.
  importc: "NETIF_CHECKSUM_GEN_ICMP6", header: "<netif.h>"
.}: cint
var NETIF_CHECKSUM_CHECK_IP* {.importc: "NETIF_CHECKSUM_CHECK_IP", header: "<netif.h>".}:
  cint
var NETIF_CHECKSUM_CHECK_UDP* {.
  importc: "NETIF_CHECKSUM_CHECK_UDP", header: "<netif.h>"
.}: cint
var NETIF_CHECKSUM_CHECK_TCP* {.
  importc: "NETIF_CHECKSUM_CHECK_TCP", header: "<netif.h>"
.}: cint
var NETIF_CHECKSUM_CHECK_ICMP* {.
  importc: "NETIF_CHECKSUM_CHECK_ICMP", header: "<netif.h>"
.}: cint
var NETIF_CHECKSUM_CHECK_ICMP6* {.
  importc: "NETIF_CHECKSUM_CHECK_ICMP6", header: "<netif.h>"
.}: cint
var NETIF_CHECKSUM_ENABLE_ALL* {.
  importc: "NETIF_CHECKSUM_ENABLE_ALL", header: "<netif.h>"
.}: cint
var NETIF_CHECKSUM_DISABLE_ALL* {.
  importc: "NETIF_CHECKSUM_DISABLE_ALL", header: "<netif.h>"
.}: cint
...
var LWIP_NSC_NETIF_REMOVED* {.importc: "LWIP_NSC_NETIF_REMOVED", header: "<netif.h>".}:
  cint
var LWIP_NSC_LINK_CHANGED* {.importc: "LWIP_NSC_LINK_CHANGED", header: "<netif.h>".}:
  cint
var LWIP_NSC_STATUS_CHANGED* {.importc: "LWIP_NSC_STATUS_CHANGED", header: "<netif.h>".}:
  cint
var LWIP_NSC_IPV4_ADDRESS_CHANGED* {.
  importc: "LWIP_NSC_IPV4_ADDRESS_CHANGED", header: "<netif.h>"
.}: cint
var LWIP_NSC_IPV4_GATEWAY_CHANGED* {.
  importc: "LWIP_NSC_IPV4_GATEWAY_CHANGED", header: "<netif.h>"
.}: cint
var LWIP_NSC_IPV4_NETMASK_CHANGED* {.
  importc: "LWIP_NSC_IPV4_NETMASK_CHANGED", header: "<netif.h>"
.}: cint
var LWIP_NSC_IPV4_SETTINGS_CHANGED* {.
  importc: "LWIP_NSC_IPV4_SETTINGS_CHANGED", header: "<netif.h>"
.}: cint
var LWIP_NSC_IPV6_SET* {.importc: "LWIP_NSC_IPV6_SET", header: "<netif.h>".}: cint
var LWIP_NSC_IPV6_ADDR_STATE_CHANGED* {.
  importc: "LWIP_NSC_IPV6_ADDR_STATE_CHANGED", header: "<netif.h>"
.}: cint
...
var INADDR_LOOPBACK* {.importc: "INADDR_LOOPBACK", header: "<sys/socket.h>".}:
  InAddrScalar
var INADDR_BROADCAST* {.importc: "INADDR_BROADCAST", header: "<sys/socket.h>".}:
  InAddrScalar
...
var IPV6_MULTICAST_HOPS* {.importc: "IPV6_MULTICAST_HOPS", header: "<sys/socket.h>".}:
  cint
var IPV6_MULTICAST_IF* {.importc: "IPV6_MULTICAST_IF", header: "<sys/socket.h>".}: cint
var IPV6_MULTICAST_LOOP* {.importc: "IPV6_MULTICAST_LOOP", header: "<sys/socket.h>".}:
  cint
