...
proc get_stringtable_entries*(
  code: ptr Pcre, name: cstring, first: cstringArray, last: cstringArray
): cint
...
proc get_substring_list*(
  subject: cstring, ovector: ptr cint, stringcount: cint, listptr: ptr cstringArray
): cint
...
proc pattern_to_host_byte_order*(
  code: ptr Pcre, extra: ptr ExtraData, tables: pointer
): cint
...
proc study*(
  code: ptr Pcre, options: cint, errptr: var cstring
): ptr ExtraData {.deprecated.}
