...
when (defined(cpp) and defined(nimUseCppAtomics)) or defined(nimdoc):
  ...
  type MemoryOrder* {.importcpp: "std::memory_order".} = enum
  ...
  proc load*[T](
    location: var Atomic[T], order: MemoryOrder = moSequentiallyConsistent
  ): T {.importcpp: "#.load(@)".} ## Atomically obtains the value of the atomic object.

  proc store*[T](
    location: var Atomic[T], desired: T, order: MemoryOrder = moSequentiallyConsistent
  ) {.importcpp: "#.store(@)".}
  ...
  ): bool {.importcpp: "#.compare_exchange_strong(@)".}
  ...
  proc compareExchange*[T](
    location: var Atomic[T], expected: var T, desired: T, success, failure: MemoryOrder
  ): bool {.importcpp: "#.compare_exchange_strong(@)".}
  ...
  proc compareExchangeWeak*[T](
    ...
    desired: T,
    order: MemoryOrder = moSequentiallyConsistent,
  ): bool {.importcpp: "#.compare_exchange_weak(@)".}
  ...
  proc testAndSet*(
    location: var AtomicFlag, order: MemoryOrder = moSequentiallyConsistent
  ): bool {.importcpp: "#.test_and_set(@)".}
    ## Atomically sets the atomic flag to true and returns the original value.

  proc clear*(
    location: var AtomicFlag, order: MemoryOrder = moSequentiallyConsistent
  ) {.importcpp: "#.clear(@)".} ## Atomically sets the value of the atomic flag to false.
  ...
  type Trivial = SomeNumber | bool | enum | ptr | pointer
  ...
  when defined(vcc):
    ...
    ): int8 {.importc: "_InterlockedExchange8".}

    proc interlockedExchange(
      location: pointer, desired: int16
    ): int16 {.importc: "_InterlockedExchange16".}

    proc interlockedExchange(
      location: pointer, desired: int32
    ): int32 {.importc: "_InterlockedExchange".}

    proc interlockedExchange(
      location: pointer, desired: int64
    ): int64 {.importc: "_InterlockedExchange64".}

    proc interlockedCompareExchange(
      location: pointer, desired, expected: int8
    ): int8 {.importc: "_InterlockedCompareExchange8".}

    proc interlockedCompareExchange(
      location: pointer, desired, expected: int16
    ): int16 {.importc: "_InterlockedCompareExchange16".}

    proc interlockedCompareExchange(
      location: pointer, desired, expected: int32
    ): int32 {.importc: "_InterlockedCompareExchange".}

    proc interlockedCompareExchange(
      location: pointer, desired, expected: int64
    ): int64 {.importc: "_InterlockedCompareExchange64".}

    proc interlockedAnd(
      location: pointer, value: int8
    ): int8 {.importc: "_InterlockedAnd8".}

    proc interlockedAnd(
      location: pointer, value: int16
    ): int16 {.importc: "_InterlockedAnd16".}

    proc interlockedAnd(
      location: pointer, value: int32
    ): int32 {.importc: "_InterlockedAnd".}

    proc interlockedAnd(
      location: pointer, value: int64
    ): int64 {.importc: "_InterlockedAnd64".}

    proc interlockedOr(
      location: pointer, value: int8
    ): int8 {.importc: "_InterlockedOr8".}

    proc interlockedOr(
      location: pointer, value: int16
    ): int16 {.importc: "_InterlockedOr16".}

    proc interlockedOr(
      location: pointer, value: int32
    ): int32 {.importc: "_InterlockedOr".}

    proc interlockedOr(
      location: pointer, value: int64
    ): int64 {.importc: "_InterlockedOr64".}

    proc interlockedXor(
      location: pointer, value: int8
    ): int8 {.importc: "_InterlockedXor8".}

    proc interlockedXor(
      location: pointer, value: int16
    ): int16 {.importc: "_InterlockedXor16".}

    proc interlockedXor(
      location: pointer, value: int32
    ): int32 {.importc: "_InterlockedXor".}

    proc interlockedXor(
      location: pointer, value: int64
    ): int64 {.importc: "_InterlockedXor64".}
    ...
    proc compareExchange*[T: Trivial](
        location: var Atomic[T],
        expected: var T,
        desired: T,
        success, failure: MemoryOrder,
    ): bool {.inline.} =
      cast[T](interlockedCompareExchange(
        addr(location.value),
        cast[nonAtomicType(T)](desired),
        cast[nonAtomicType(T)](expected),
      )) == expected
    ...
    proc compareExchangeWeak*[T: Trivial](
        location: var Atomic[T],
        expected: var T,
        desired: T,
        success, failure: MemoryOrder,
    ...
    proc fetchAdd*[T: SomeInteger](
      ...
      while not compareExchangeWeak(location, currentValue, currentValue + value):
        discard
    ...
    type MemoryOrder* {.importc: "memory_order".maybeWrapStd.} = enum
      moRelaxed
      moConsume
      moAcquire
      moRelease
    ...
    proc atomic_load_explicit[T, A](
      location: ptr A, order: MemoryOrder
    ): T {.importc: "atomic_load_explicit".maybeWrapStd.}

    proc atomic_store_explicit[T, A](
      location: ptr A, desired: T, order: MemoryOrder = moSequentiallyConsistent
    ) {.importc: "atomic_store_explicit".maybeWrapStd.}

    proc atomic_exchange_explicit[T, A](
      location: ptr A, desired: T, order: MemoryOrder = moSequentiallyConsistent
    ): T {.importc: "atomic_exchange_explicit".maybeWrapStd.}

    proc atomic_compare_exchange_strong_explicit[T, A](
      location: ptr A, expected: ptr T, desired: T, success, failure: MemoryOrder
    ): bool {.importc: "atomic_compare_exchange_strong_explicit".maybeWrapStd.}

    proc atomic_compare_exchange_weak_explicit[T, A](
      location: ptr A, expected: ptr T, desired: T, success, failure: MemoryOrder
    ): bool {.importc: "atomic_compare_exchange_weak_explicit".maybeWrapStd.}

    # Numerical operations
    proc atomic_fetch_add_explicit[T, A](
      location: ptr A, value: T, order: MemoryOrder = moSequentiallyConsistent
    ): T {.importc: "atomic_fetch_add_explicit".maybeWrapStd.}

    proc atomic_fetch_sub_explicit[T, A](
      location: ptr A, value: T, order: MemoryOrder = moSequentiallyConsistent
    ): T {.importc: "atomic_fetch_sub_explicit".maybeWrapStd.}

    proc atomic_fetch_and_explicit[T, A](
      location: ptr A, value: T, order: MemoryOrder = moSequentiallyConsistent
    ): T {.importc: "atomic_fetch_and_explicit".maybeWrapStd.}

    proc atomic_fetch_or_explicit[T, A](
      location: ptr A, value: T, order: MemoryOrder = moSequentiallyConsistent
    ): T {.importc: "atomic_fetch_or_explicit".maybeWrapStd.}

    proc atomic_fetch_xor_explicit[T, A](
      location: ptr A, value: T, order: MemoryOrder = moSequentiallyConsistent
    ): T {.importc: "atomic_fetch_xor_explicit".maybeWrapStd.}
    ...
    proc testAndSet*(
      location: var AtomicFlag, order: MemoryOrder = moSequentiallyConsistent
    ): bool {.importc: "atomic_flag_test_and_set_explicit".maybeWrapStd.}

    proc clear*(
      location: var AtomicFlag, order: MemoryOrder = moSequentiallyConsistent
    ) {.importc: "atomic_flag_clear_explicit".maybeWrapStd.}

    proc fence*(order: MemoryOrder) {.importc: "atomic_thread_fence".maybeWrapStd.}
    proc signalFence*(
      order: MemoryOrder
    ) {.importc: "atomic_signal_fence".maybeWrapStd.}
    ...
    proc load*[T: Trivial](
      ...
      cast[T](atomic_load_explicit[nonAtomicType(T), typeof(location.value)](
        addr(location.value), order
      ))
    ...
    proc store*[T: Trivial](
      ...
      atomic_store_explicit(
        addr(location.value), cast[nonAtomicType(T)](desired), order
      )
    ...
    proc exchange*[T: Trivial](
      ...
      cast[T](atomic_exchange_explicit(
        addr(location.value), cast[nonAtomicType(T)](desired), order
      ))
    ...
    proc fetchAdd*[T: SomeInteger](
      ...
      cast[T](atomic_fetch_add_explicit(
        addr(location.value), cast[nonAtomicType(T)](value), order
      ))

    proc fetchSub*[T: SomeInteger](
        location: var Atomic[T], value: T, order: MemoryOrder = moSequentiallyConsistent
    ): T {.inline.} =
      cast[T](atomic_fetch_sub_explicit(
        addr(location.value), cast[nonAtomicType(T)](value), order
      ))
    ...
    proc fetchAnd*[T: SomeInteger](
      ...
      cast[T](atomic_fetch_and_explicit(
        addr(location.value), cast[nonAtomicType(T)](value), order
      ))
    ...
    proc fetchOr*[T: SomeInteger](
      ...
      cast[T](atomic_fetch_or_explicit(
        addr(location.value), cast[nonAtomicType(T)](value), order
      ))
    ...
    proc fetchXor*[T: SomeInteger](
      ...
      cast[T](atomic_fetch_xor_explicit(
        addr(location.value), cast[nonAtomicType(T)](value), order
      ))

  template withLock[T: not Trivial](
      location: var Atomic[T], order: MemoryOrder, body: untyped
  ): untyped =
  ...
  proc compareExchange*[T: not Trivial](
      location: var Atomic[T],
      expected: var T,
      desired: T,
      success, failure: MemoryOrder,
  ...
  proc compareExchangeWeak*[T: not Trivial](
      location: var Atomic[T],
      expected: var T,
      desired: T,
      success, failure: MemoryOrder,
