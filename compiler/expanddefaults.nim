...
template newZero(t: PType, info: TLineInfo, k = nkIntLit): PNode =
  newNodeIT(k, info, t)
...
proc expandDefault(t: PType, info: TLineInfo): PNode =
  ...
  of tyInt8:
    result = newZero(t, info, nkInt8Lit)
  of tyInt16:
    result = newZero(t, info, nkInt16Lit)
  of tyInt32:
    result = newZero(t, info, nkInt32Lit)
  of tyInt64:
    result = newZero(t, info, nkInt64Lit)
  of tyUInt:
    result = newZero(t, info, nkUIntLit)
  of tyUInt8:
    result = newZero(t, info, nkUInt8Lit)
  of tyUInt16:
    result = newZero(t, info, nkUInt16Lit)
  of tyUInt32:
    result = newZero(t, info, nkUInt32Lit)
  of tyUInt64:
    result = newZero(t, info, nkUInt64Lit)
  of tyFloat:
    result = newZero(t, info, nkFloatLit)
  of tyFloat32:
    result = newZero(t, info, nkFloat32Lit)
  of tyFloat64:
    result = newZero(t, info, nkFloat64Lit)
  of tyFloat128:
    result = newZero(t, info, nkFloat64Lit)
  of tyChar:
    result = newZero(t, info, nkCharLit)
  of tyBool:
    result = newZero(t, info, nkIntLit)
  of tyEnum:
  ...
  of tyNone, tyEmpty, tyUntyped, tyTyped, tyTypeDesc, tyNil, tyGenericInvocation,
      tyError, tyBuiltInTypeClass, tyUserTypeClass, tyUserTypeClassInst,
      tyCompositeTypeClass, tyAnd, tyOr, tyNot, tyAnything, tyConcept, tyIterable,
      tyForward:
