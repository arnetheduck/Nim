...
import
  ast, types, msgs, wordrecg, platform, trees, options, cgendata, mangleutils, renderer
  ...
  of tyObject:
    if s.typ.sym != nil and sfForward in s.typ.sym.flags:
      ...
      result = true
        ...
        conf.selectedGC notin {gcArc, gcAtomicArc, gcOrc, gcHooks}:
      # bug #23354:
      result = false
...
proc encodeSym*(
    m: BModule, s: PSym, makeUnique: bool = false, extra: string = ""
): string =
  #Module::Type
...
proc encodeType*(m: BModule, t: PType, staticLists: var string): string =
  ...
  of tySequence, tyOpenArray, tyArray, tyVarargs, tyTuple, tyProc, tySet, tyTypeDesc,
      tyPtr, tyRef, tyVar, tyLent, tySink, tyUncheckedArray, tyOr, tyAnd,
      tyBuiltInTypeClass:
    result =
      case t.kind
      of tySequence:
